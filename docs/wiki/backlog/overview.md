...
- [US-044: Gestione dei collaboratori ingaggiati dalla pagina offerte](specs/US-044.md) — **REVIEW**, 2 point(s).
- [US-045: Creazione di un utente con ruoli combinabili e profilo collaboratore immediato](specs/US-045.md) — **DONE**, 3 point(s).
- [US-046: Aggiunta e rimozione del ruolo Collaboratore su un utente esistente](specs/US-046.md) — **DONE**, 3 point(s).
...
- [US-043: Inserimento ore consentito solo sulle offerte abilitate](specs/US-043.md) — **DONE**, 3 point(s).
