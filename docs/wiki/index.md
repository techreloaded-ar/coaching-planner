...
* [Mappa dei contesti candidati](architecture/context-map.md) - Relazioni tra capability candidate, infrastruttura condivisa e confini ancora da revisionare. _State: evidence-changed._
...
* [Cache client dell'area attività del collaboratore — mesi del calendario e giornate](decisions/cache-client-calendario-collaboratore.md) - Isole SPA su calendario e dettaglio giornata con GET autenticati, cache in memoria della scheda con TTL 300 s e guardia d'identità condivisa, invece del runtime prefetching non stabile. _State: generated._
...
* [Feedback di attesa e cursore uniformi](decisions/feedback-attesa-uniforme.md) - Cursore dal base layer e un unico PulsanteAttesa basato su useFormStatus, invece di classi e wiring pending ad hoc su ogni pulsante. _State: evidence-changed._
* [Fotografia del rimborso trasferta sulla riga attività](decisions/fotografia-rimborso-trasferta.md) - Congelare etichetta e importo della voce di rimborso sulla riga al salvataggio, senza chiave esterna né versioning delle voci. _State: evidence-changed._
...
* [PostgreSQL con target SiteGround](decisions/postgres-siteground.md) - Usare PostgreSQL con target dichiarato SiteGround e sviluppo locale equivalente. _State: reviewed._
...
* [Clienti](domains/clienti.md) - Anagrafica fiscale dei clienti e loro abilitazione operativa. _State: reviewed._
...
* [Politiche di rimborso trasferta](domains/politiche-rimborso.md) - Configurazione globale delle voci di rimborso trasferta a etichetta libera e importo forfettario. _State: reviewed._
...
* [Panoramica](overview.md) - Scopo, attori, stack e perimetro della mappa codebase-first di Coaching Planner. _State: evidence-changed._
